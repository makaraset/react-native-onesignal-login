...
class OSDemo extends React.Component<Props, State> {
  ...
  async componentDidMount() {
    ...
    //     OneSignal.User.addAlias('external_id', 'officer1');
    //     OneSignal.User.addTag('external_id', 'officer1');

    // Disable Identity Verification for email + external_id (recommended) in onesignal
